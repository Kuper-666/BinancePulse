...
; Используйте Inno Setup Compiler (ISCC) для сборки

[Setup]
AppId={{B9E8F2A1-5C7D-4A3E-8F2C-9D7E5B4A3C2F}}
AppName=BinancePulse
AppVersion={#GetFileVersion('BinancePulse\bin\Release\net8.0-windows\win-x64\publish\BinancePulse.exe')}
...
[Files]
; Основной EXE и все файлы из папки publish
Source: "BinancePulse\bin\Release\net8.0-windows\win-x64\publish\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs

; Если есть дополнительные файлы (например, config, Data, Logs) – включите их отдельно
; Source: "BinancePulse\Data\*"; DestDir: "{app}\Data"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "*.json"
; Source: "BinancePulse\Logs\*"; DestDir: "{app}\Logs"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
  ...
  begin
    // Удаляем папки с пользовательскими данными (по желанию)
